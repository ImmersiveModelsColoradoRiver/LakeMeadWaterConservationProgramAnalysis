...
load.lib <- c("tidyverse", "readxl", "RColorBrewer", "dplyr", "expss", "reshape2", "pracma", "lubridate", "directlabels", "plyr", "stringr", "ggplot2", "ggpubr", "ggrepel", "rvest", "tidyr", "dataRetrieval", "zoo", "here")

# Then we select only the packages that aren't currently installed.
install.lib <- load.lib[!load.lib %in% installed.packages()]
# And finally we install the missing packages, including their dependency.
for(lib in install.lib) install.packages(lib,dependencies=TRUE, repos = "https://cloud.r-project.org")
...
#   #List of packages
#   load.lib <- c("tidyverse", "readxl", "RColorBrewer", "dplyr", "expss", "reshape2", "pracma", "lubridate", "directlabels", "plyr", "stringr", "ggplot2", "ggpubr", "ggrepel", "rvest", "tidyr", "dataRetrieval", "zoo", "here", "knitr")
# 
#  # Then we select only the packages that aren't currently installed.
#   install.lib <- load.lib[!load.lib %in% installed.packages()]
# # And finally we install the missing packages, including their dependency.
...
############## Make local copies of the ICS Data
